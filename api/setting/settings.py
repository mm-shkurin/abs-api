...
SECRET_KEY = 'django-insecure-_nf$t10y)!(h%77!zrfm)*lcdz1iwz7xt)^u=g=vzgsuum$n-0'
...
CORS_ORIGIN_ALLOW_ALL = True  # Или настроить CORS_ORIGIN_WHITELIST

CORS_ORIGIN_ALLOW_HEADERS = ['*']  # Или настроить CORS_ORIGIN_WHITELIST
...
STATIC_URL = '/static/'
STATIC_ROOT = 'f:/absolute/api/staticfiles'

# URL для доступа к медиа-файлам
MEDIA_URL = '/media/'
MEDIA_ROOT = 'f:/absolute/api/media'

# Путь к директории, куда будут загружаться медиа-файлы
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Убедитесь, что эта директория существует
